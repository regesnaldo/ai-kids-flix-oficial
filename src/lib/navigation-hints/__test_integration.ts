...
if (process.env.NODE_ENV === "development") console.log("PASS: NAV tags stripped from visible text");

// Assert: 2 hints extraídos
console.assert(bundle.hints.length === 2, `FAIL: Expected 2 hints, got ${bundle.hints.length}`);
if (process.env.NODE_ENV === "development") console.log(`PASS: ${bundle.hints.length} hints extracted`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Series hint priority = ${seriesHint!.priority}`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Lab hint priority = ${labHint!.priority}`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Dominant section = ${bundle.dominantSection}`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: ${beacons.length} beacons generated`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Series beacon intensity = ${seriesBeacon!.pulseIntensity}`);
if (process.env.NODE_ENV === "development") console.log(`PASS: Beacon subtitle = "${seriesBeacon!.subtitle}"`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: ${active.length} active beacons`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Mission created — layer ${getLayerLabel(mission.currentLayer)}`);
...
if (process.env.NODE_ENV === "development") console.log("PASS: Node unlocked");

// Visit node
state = visitNode(state, state.unlockedNodes[0].nodeId);
console.assert(state.currentNode !== null, "FAIL: currentNode not set");
if (process.env.NODE_ENV === "development") console.log("PASS: Node visited");
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Progression score = ${state.progressionScore}`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Node completed — progression ${state.progressionScore}%, layer ${getLayerLabel(state.currentLayer)}`);

// Get next suggested path
const nextPath = getNextSuggestedPath(state);
if (process.env.NODE_ENV === "development") console.log(`PASS: Next suggested path = ${nextPath}`);
...
if (process.env.NODE_ENV === "development") console.log("PASS: Handoff payload created and valid");
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Handoff processed — "${result.continuationMessage}"`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: ${actions.length} trigger rules fired`);

const seriesAction = actions.find((a) => a.target === "series");
console.assert(seriesAction !== undefined, "FAIL: No series trigger action");
if (process.env.NODE_ENV === "development") console.log(`PASS: Series trigger — "${seriesAction!.payload.reason}"`);

const hint = buildHintFromAction(actions[0], "home");
console.assert(hint.section !== undefined, "FAIL: Hint has no section");
if (process.env.NODE_ENV === "development") console.log(`PASS: Action → Hint → section: ${hint.section}`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: LAB initial state = ${lab.state} — "${lab.statusText}"`);

// idle → scanning
lab = transition(lab, "scanning");
console.assert(lab.state === "scanning", `FAIL: Expected scanning, got ${lab.state}`);
if (process.env.NODE_ENV === "development") console.log(`PASS: LAB → scanning — "${lab.statusText}"`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: LAB → processing — "${lab.statusText}"`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: Progress = ${progress}% after 2/4 agents`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: LAB → synthesis — "${lab.statusText}"`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: LAB → complete — "${lab.statusText}"`);
...
if (process.env.NODE_ENV === "development") console.log(`PASS: LAB → error — "${lab.statusText}"`);

// ═══ SUMMARY ═══════════════════════════════════════════════════════════════════

if (process.env.NODE_ENV === "development") console.log("\n═══════════════════════════════════════");
if (process.env.NODE_ENV === "development") console.log("  ALL 6 TEST SUITES PASSED");
if (process.env.NODE_ENV === "development") console.log("═══════════════════════════════════════");
if (process.env.NODE_ENV === "development") console.log("  Extraction:     ✅ NAV tags parsed + stripped");
if (process.env.NODE_ENV === "development") console.log("  Beacons:        ✅ Urgent/series, subtle/lab");
if (process.env.NODE_ENV === "development") console.log("  Mission:        ✅ Layer progression tracked");
if (process.env.NODE_ENV === "development") console.log("  Handoff:        ✅ Context survives navigation");
if (process.env.NODE_ENV === "development") console.log("  Triggers:       ✅ 2+ rules fired from discovery");
if (process.env.NODE_ENV === "development") console.log("  LAB Machine:    ✅ Full state cycle validated");
if (process.env.NODE_ENV === "development") console.log("═══════════════════════════════════════\n");
