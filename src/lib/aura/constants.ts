// ─── src/lib/aura/constants.ts ──────────────────────────────────────────────
// FASE 12A — Aura Dinâmica: cores, thresholds e mapeamentos

import type { AuraColorName, AuraIntensity, AuraPattern, AuraPhase } from "./types";

// 12 cores hex mapeadas às 4 fases narrativas
...
// Faixas de score → cor, intensidade, padrão
...
// Peso de cada componente no cálculo do score
