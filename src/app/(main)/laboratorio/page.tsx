    ...
    <main className="relative min-h-screen overflow-hidden bg-[#05060c] text-white">
      ...
      <section className="relative mx-auto flex w-full max-w-7xl flex-col px-4 pb-16 pt-12 md:px-8">
        ...
        <header className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <div className="mt-5 flex items-center justify-center gap-4 flex-wrap"><div className="flex items-center gap-4 text-xs text-gray-500">
              <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-blue-500" />4 Zonas</span>
              <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-purple-500" />3D ao vivo</span>
              <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-green-500" />4 Agentes IA</span>
            </div>
          </div>
        </header>
