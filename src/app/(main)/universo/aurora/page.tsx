...
const AGENT = {
  ...
  role: 'A Criadora',
  description: 'Mostrar como palavras existem como pontos em espaço multidimensional. Imagine cada palavra como um brilho num cosmos de significados.',
  approach: 'Criativo, poético, inspirador. Transforma conceitos abstratos em paisagens mentais.',
  color: '#EC4899',
...
export default function AuroraUniversePage() {
  return (
    <main className="relative w-full h-screen overflow-hidden" style={{ background: '#0a0a1a' }}>
      <div className="absolute inset-0 z-0"><AuroraScene /></div>
