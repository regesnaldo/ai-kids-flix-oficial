...
const TerraScene = dynamic(
  () => import('@/components/scenes/TerraScene').then((m) => m.TerraScene),
...
const AGENT = {
  ...
  role: 'A Guardiã',
  description: 'Explorar o impacto humano da IA — quem ela ajuda e quem ela prejudica.',
  approach: 'Calorosa, protetora, profundamente humana. "A tecnologia serve a vida, não o contrário."',
  color: '#22C55E',
...
export default function TerraUniversePage() {
  return (
    <main className="relative w-full h-screen overflow-hidden" style={{ background: '#0a0a1a' }}>
      <div className="absolute inset-0 z-0"><Canvas><TerraScene /></Canvas></div>
