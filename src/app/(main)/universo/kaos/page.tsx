...
const KaosScene = dynamic(
  () => import('@/components/scenes/KaosScene').then((m) => m.KaosScene),
...
const AGENT = {
  ...
  description: 'Explorar como o caos gera inovação na IA. O que acontece quando um modelo erra de propósito?',
  approach: 'Provoca, desestabiliza e reconstrói. Fala em paradoxos e metáforas explosivas.',
  color: '#EF4444',
...
export default function KaosUniversePage() {
  return (
    <main className="relative w-full h-screen overflow-hidden" style={{ background: '#0a0a1a' }}>
      <div className="absolute inset-0 z-0"><Canvas><KaosScene /></Canvas></div>
