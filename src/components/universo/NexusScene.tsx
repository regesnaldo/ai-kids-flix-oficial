...
import { Points, PointMaterial, Sphere, Float, Sparkles } from '@react-three/drei';
...
function FloatingParticles() {
  ...
  useFrame((state) => {
    ...
    for (let i = 0; i < PARTICLE_COUNT; i++) {
      ...
      const breath = Math.sin(time * 0.3 + i * 0.01) * 0.02;
      const swirl = Math.cos(time * 0.1 + i * 0.005) * 0.01;
      
      positions.setX(i, baseX + breath);
      positions.setY(i, baseY + swirl);
      positions.setZ(i, baseZ + breath * 0.5);
    }
